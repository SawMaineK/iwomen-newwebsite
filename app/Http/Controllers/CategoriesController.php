...
class CategoriesController extends Controller {
	...
	public function getShow( Request $request, $id = null)
	{
		...
		if($row)
		{
			...
			return Redirect::to('categories')->with('messagetext','Record Not Found !')->with('msgstatus','error');					
		}
	}	
	...
	function postSave( Request $request)
	{
		...
		if ($validator->passes()) {
			...
			return Redirect::to('categories/update/'.$request->input('id'))->with('messagetext',\Lang::get('core.note_error'))->with('msgstatus','error')
	...
	public function postDelete( Request $request)
	{
		...
		if(count($request->input('ids')) >=1)
		{
			...
			// redirect
			return Redirect::to('categories?return='.self::returnUrl())
