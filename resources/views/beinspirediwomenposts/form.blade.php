...
<div class="page-content row">
    ...
    <div class="page-content-wrapper m-t">
        ...
        {!! Form::open(array('url'=>'beinspirediwomenposts/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!} 
                ...
                <div class="row">
                    <div class="form-actions">
                        <div class="col-md-offset-4 col-md-8">
                            ...
                            <button type="button" onclick="location.href='{{ URL::to('beinspirediwomenposts?return='.$return) }}' " class="btn red "><i class="fa fa-close "></i> {{ Lang::get('core.sb_cancel') }} </button>
                        </div>
