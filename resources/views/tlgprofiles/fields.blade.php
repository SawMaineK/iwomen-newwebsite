...
<!-- Tlg Group Logo Image  -->
<div class="form-group {{ $errors->has('tlg_group_logo') ? 'has-error' : '' }}  " >
	<label for="Tlg Group Logo Image" class=" control-label col-xs-12 col-md-4 text-left"> Tlg Group Logo Image <span class='asterix'> * </span></label>
	<div class="col-xs-12 col-md-7">
...
<div class="form-group {{ $errors->has('is_leader') ? 'has-error' : '' }}  " >
	...
	<label class='radio radio-inline'>
		<input type='radio' name='is_leader' value ='1' required  class='icheck ' 	@if($row['is_leader'] == '1') checked="checked" @endif > BOD Member </label>
	<label class='radio radio-inline'>
		<input type='radio' name='is_leader' value ='0' required  class='icheck ' 	@if($row['is_leader'] == '0') checked="checked" @endif > No BOD Member </label>
</div>
...
<div class="form-group {{ $errors->has('tlg_leader_img') ? 'has-error' : '' }}  " >
	<label for="Tlg Leader Image" class=" control-label col-xs-12 col-md-4 text-left"> Tlg Leader Image <span class='asterix'> * </span></label>
	<div class="col-xs-12 col-md-7">
