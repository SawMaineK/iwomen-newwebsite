...
<div class="page-content row">
    ...
    <div class="page-content-wrapper m-t">
        ...
        {!! Form::open(array('url'=>'iwomenpostaudio/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'data-parsley-validate'=>'')) !!} 
        <div class="portlet light bordered animated fadeInUp ">
            ...
            <div class="portlet-body">
                ...
                @endif
                <div class="row">
                    @include('iwomenpostaudio.fields')
                </div>
                ...
                <div class="row">
                    <div class="form-actions">
                        <div class="col-md-offset-4 col-md-8">
                            ...
                            <button type="button" onclick="location.href='{{ URL::to('iwomenpostaudio?return='.$return) }}' " class="btn red "><i class="fa fa-close "></i> {{ Lang::get('core.sb_cancel') }} </button>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
		...
		$("#post_id").jCombo("{!! url('iwomenpostaudio/comboselect?filter=iwomenPosts:id:title|titleMm') !!}",
